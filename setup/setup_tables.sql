...
insert into imperial_secrets ( secret ) values ('The real, secret sith master is Jar Jar Binks');
insert into imperial_secrets ( secret ) values ('The Imperium has no cookies');
