...
insert into deathstar_rooms ( name ) values ( 'Engine Room 1' );
insert into deathstar_rooms ( name ) values ( 'Vaders Chamber' );
insert into deathstar_rooms ( name ) values ( 'Bridge' );
insert into deathstar_rooms ( name ) values ( 'Prison 1' );
